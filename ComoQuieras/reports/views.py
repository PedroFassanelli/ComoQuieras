...
class ReportePersonalizadoExcel(TemplateView):
    def get(self, request, *args, **kwargs):
        ...
        ws['N1'].border = Border(left = Side(border_style = "thin"), right = Side(border_style = "thin"),
                                top = Side(border_style = "thin"), bottom = Side(border_style = "thin") ) 
        ...
        ws['T1'].border = Border(left = Side(border_style = "thin"), right = Side(border_style = "thin"),
                                top = Side(border_style = "thin"), bottom = Side(border_style = "thin") ) 
        ...
        ws['Z1'].border = Border(left = Side(border_style = "thin"), right = Side(border_style = "thin"),
                                top = Side(border_style = "thin"), bottom = Side(border_style = "thin") ) 
        ...
        ws['AF1'].border = Border(left = Side(border_style = "thin"), right = Side(border_style = "thin"),
                                top = Side(border_style = "thin"), bottom = Side(border_style = "thin") ) 
        ...
        ws['R2'].border = Border(left = Side(border_style = "thin"), right = Side(border_style = "thin"),
                                top = Side(border_style = "thin"), bottom = Side(border_style = "thin") )
        ...
        ws['X2'].border = Border(left = Side(border_style = "thin"), right = Side(border_style = "thin"),
                                top = Side(border_style = "thin"), bottom = Side(border_style = "thin") )
        ...
        ws['AD2'].border = Border(left = Side(border_style = "thin"), right = Side(border_style = "thin"),
                                top = Side(border_style = "thin"), bottom = Side(border_style = "thin") )
        ...
        ws['AE3'].border = Border(left = Side(border_style = "thin"), right = Side(border_style = "thin"),
                                top = Side(border_style = "thin"), bottom = Side(border_style = "thin") )
        ...
        ws['AH3'].border = Border(left = Side(border_style = "thin"), right = Side(border_style = "thin"),
                                top = Side(border_style = "thin"), bottom = Side(border_style = "thin") )
        ...
        for p in pedidos:
            cont+=1
            ws["A" + str(cont)] = p.user.last_name + ", " + p.user.first_name
            ws["A" + str(cont)].alignment = Alignment(horizontal = "center", vertical = "center")   
            ws["A" + str(cont)].border = Border(left = Side(border_style = "thin"), right = Side(border_style = "thin"),
                                top = Side(border_style = "thin"), bottom = Side(border_style = "thin") )
            for l in lineas:
                if l.pedido == p:
                    columna = ""
                    ...
                    ws[columna + str(cont)] = l.cantidad
                    ws[columna + str(cont)].alignment = Alignment(horizontal = "center", vertical = "center")
        ...
        for row in ws.iter_rows(min_row=4, min_col=2, max_col=31, max_row=cont, values_only=True):
            cont_rows += 1
            contador = 0
            c_medias = 0
            c_enteras = 0
        ...
        cant_cols = 0
        for col in ws.iter_cols(min_row=4, min_col=2, max_col=34, max_row=cont):
            cant_cols +=1
            cant_filas = 0
            total = 0
